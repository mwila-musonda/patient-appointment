            ...
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
                <tr >
                    ...
                    <td width="15%">
                        ...
                        $list110 = $database->query("SELECT s.title, d.docname,s.scheduledate FROM schedule s
                ...
                $sqlmain= "SELECT s.title, d.docname,s.scheduledate,s.scheduletime,s.scheduleid FROM schedule s
                            LEFT JOIN appointment a ON a.scheduleid = s.scheduleid
                            LEFT JOIN patient p ON p.pid = a.pid
                            LEFT JOIN doctor d ON d.docid = s.docid 
                            WHERE p.pid = $userid"
                        ...
                        <tbody>
                            ...
                            <?php
                                ...
                                if(empty($result)|| !$result){
                                    echo "You have no scheduled sessions";
                                    die();
                                }
