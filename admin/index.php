            ...
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;" >
                        ...
                        <tr >
                            ...
                            <td width="15%">
                                ...
                                $specialisties = $database->query("select * from specialties");
                            ...
                            <tr>
                                ...
                                <td style="width: 25%;">
                                    <div  class="dashboard-items"  style="padding:20px;margin:auto;width:95%;display: flex; ">
                                        <div>
                                                <div class="h1-dashboard" >
                                                    <?php    echo $specialisties ->num_rows  ?>
                                                </div><br>
                                                <div class="h3-dashboard" >
                                                    Specialties &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;
                                                </div>
                                        </div>
                                            <div class="btn-icon-back dashboard-icons" style="margin-left: 0px;background-image: url('../img/icons/award.svg');"></div>
                                    </div>
                                </td>
                                <td style="width: 25%;">
